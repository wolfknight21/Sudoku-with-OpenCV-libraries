...
# Anchura ID numero 3, Altura ID numero 4
cap.set(3, frameWidth)
cap.set(4, frameHeight)

# Cambia el brillo a 150
cap.set(10, 150)

# Carga el modelo y los anchos
...
while True:
    ...
    if time_elapsed > 1. / frame_rate:
        ...
        if corners:
            ...
            # Si no reconoce nada o es imposible diferenciar el modelo, continua en ejecución
            if squares_guesses in seen and seen[squares_guesses] is False:
                continue

            # Si ya resolvimos este acertijo, solo busque la otra solución
